...
using Domain.Models;
using Infra.Banco.Repositorio.BaseRepositorio;

namespace Infra.Banco.Repositorio
{
    public class ProdutoRepositorio : BasePaginacao<Produto>, IProdutoRepositorio
    {
        ...
        public void InserirProdutos()
        {
            AddRange(
            [
                new () { Id = 1, Nome = "Produto A", Valor = 10.99m },
                new () { Id = 2, Nome = "Produto B", Valor = 15.49m },
                new () { Id = 3, Nome = "Produto C", Valor = 20.00m },
                new () { Id = 4, Nome = "Produto D", Valor = 5.75m },
                new () { Id = 5, Nome = "Produto E", Valor = 7.25m },
            ]);
        }
